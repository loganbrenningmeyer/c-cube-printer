...
cubePrinter.c: Animates random cube rotation in the terminal or prints cube with user-specified size/orientation
infiniteCube.c: Animates infinitely rotating cube until the user terminates the program (CTRL+C)
